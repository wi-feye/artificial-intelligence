...
class Parameter:
    def __init__(self):
        ...
        self.n_env = 3
        # (y-m-d) 2022-11-9: 'X rooms', 2022-11-21: 'Fibonacci'
        self.start_time = [datetime.datetime(2022, 11, 9), datetime.datetime(2022, 11, 21)][self.select_building]
